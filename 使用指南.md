...
git add . && git commit -m "2025年11月6日  新增2本书 换pixel " && git push origin main
git add . && git commit -m "2025年11月6日  增加长冷却3h  " && git push origin main

git add . && git commit -m "2025年11月6日  3次 2h  " && git push origin main
```
